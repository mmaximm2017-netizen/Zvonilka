...
if 'GlassBottomBar(backdrop:Backdrop' not in s:
    ...
    # Let rows actually pass behind the floating glass, while keeping the last item reachable.
...
g=g.replace('versionCode = 26','versionCode = 27').replace('versionName = "0.11.8"','versionName = "0.11.9"')
g=g.replace('implementation("io.github.kyant0:backdrop:2.0.1")','implementation("io.github.kyant0:backdrop:1.0.0")')
needle='    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.8.7")\n'
if 'io.github.kyant0:backdrop' not in g:
    g=g.replace(needle,needle+'    implementation("io.github.kyant0:backdrop:1.0.0")\n',1)
p.write_text(g)
